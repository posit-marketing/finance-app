...
#| eval: false
url <-
  "https://pub.demo.posit.team/public/lend-fit-vetiver-pin/"
...
predictions_df <- reactive({
  ...
  url <-
    "https://pub.demo.posit.team/public/lend-fit-vetiver-pin/predict"
...
cards <- list(
  ...
  card(full_screen = TRUE,
       card_header("Percentage of all bankcard accounts > 75"),
       card_body(
         numericInput(
