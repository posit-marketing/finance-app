...
Once the data is accessible, the [tidymodels framework of packages](https://www.tidymodels.org/) offer modeling and machine learning capabilities. Analysts can use these tools in managed environments with their preferred IDE in [Posit Workbench](https://posit.co/products/enterprise/workbench/) and schedule, share, and scale their models in [Posit Connect](https://posit.co/products/enterprise/connect/). The integration of tools combines the data governance strengths of Databricks with the powerful tools offered by Posit, making their work more productive and streamlined.
...
#| eval: false
url <-
  "https://pub.demo.posit.team/public/lend-fit-vetiver-api/"
  ...
  card(full_screen = TRUE,
       ...
       card_body(
         selectInput(
           ...
           selected = "36 months",
           label = HTML("<br><br>Select 36 or 60 months:")
         )
       )), 
  card(full_screen = TRUE,
  ...
  card(full_screen = TRUE,
       ...
       card_body(
         numericInput(
           ...
           label = HTML("Input a number between<br>0 to 100:"),
           value = 50,
           min = 0,
           max = 100,
           step = 5
...
ui <- bslib::page(
  ...
  layout_columns(width = 1/5,
                 height =250,
                 cards[[2]], cards[[3]], cards[[5]], cards[[4]], cards[[1]]),
...
* Check out the [Databricks x Posit Solutions Page](https://posit.co/solutions/databricks/).
